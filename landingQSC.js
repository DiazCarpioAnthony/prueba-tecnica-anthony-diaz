...
`;
  ...
  var cssAdc = [
      ...
      '.adc_section-footer__stores{align-items:center;display:flex;flex-wrap:wrap;gap:10px;justify-content:center;margin-top:4px;max-width:280px;width:100%}',
      ...
      '.adc_section-footer__store-img{display:block;height:40px;object-fit:contain;width:auto}',
